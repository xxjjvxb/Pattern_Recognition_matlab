function [wrong_count] = texture_219(scale,sample_number,except_bright,try_numb,print)
...
N_img = 12;
lookup_size = 32;
if(~scale) scale = 16; end
if(~sample_number) sample_number = 100; end
if(~except_bright) except_bright = 0; end % DC 성분을 제외 하는지 마는지.
if(try_numb == 0) try_numb = 1; end% 비교 대상의 임의 좌표 시도 횟수
if(~print) print = 0; end% 비교 대상의 임의 좌표 시도 횟수
wrong_count = 0;

img_av(1:scale,1:scale,1:N_img) = 0;
